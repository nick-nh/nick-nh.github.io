...
Если используется последняя версии модуля отправки сообщений и последняя версия скрипта, то есть возможность указания индивидуальных настроек отправки сообщений в Телеграм.
